...
import { useGetMemberDetailByIdQuery, useGetHCListByTypeQuery, useActionListQuery } from 'Rtk/services/user';
...
import { useGetDeptListQuery } from 'Rtk/services/company';
...
const EmployeeDetails = () => {
    ...
    const result = useGetMemberDetailByIdQuery({ userId: id }, {
    ...
    const actionCount = useActionListQuery({ user_id: actionGetId, type: selectedItemKeyword, startDate, endDate }, {
        refetchOnMountOrArgChange: true,
    })
